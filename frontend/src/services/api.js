...
export const BASE_URL = isLocal ? 'http://localhost:3000/api' : 'https://app-truyen-hckg.onrender.com/api';
export const STORAGE_URL = isLocal ? 'http://localhost:3000' : 'https://app-truyen-hckg.onrender.com';
